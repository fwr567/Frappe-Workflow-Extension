...
frappe.ui.form.on("NL Workflow", {
	...
	get_orphaned_states_and_count: function (frm) {
		...
		return frappe
			.xcall(
				"frappe_workflow_extension.frappe_workflow_extension.doctype.nl_workflow.nl_workflow.get_workflow_state_count",
				{
...
frappe.ui.form.on("NL Workflow Document State", {
...
frappe.ui.form.on("NL Workflow Transition", {
	state: function (_, cdt, cdn) {
		var row = locals[cdt][cdn];
		delete row.workflow_builder_id;
	},
